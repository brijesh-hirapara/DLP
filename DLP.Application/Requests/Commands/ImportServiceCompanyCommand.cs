...
{
    public class ImportServiceCompanyCommand : IRequest<string>
    {
        public IFormFile ImportFile { get; set; }
    }

    public class ImportServiceCompanyCommandHandler : IRequestHandler<ImportServiceCompanyCommand, string>
    {
        ...
        public async Task<string> Handle(ImportServiceCompanyCommand command, CancellationToken cancellationToken)
        {
            try
            {
                   ...
                   .ToList();
                        ...
                        for (int row = 2; row <= rowCount; row++)
                        {
                            ...
                            var request = new Request
                            {
                                ...
                                //Type = RequestType.RequestForExtensionOfLicenseOfServiceCompanies,

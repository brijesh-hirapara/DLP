...
const ActivitiesWrapper = Styled.div`
    ...
    .activity-single{
        ...
        .project-search .ant-select-selector,
        .project-search .ant-input-affix-wrapper {
        ...
        .project-sort .sort-label {
            color: #888;
            font-size: 14px;
        }

        .project-sort .ant-select-selector {
            border-radius: 9999px !important;
...
`;
 ...
 const ProjectToolbarWrapper  = Styled.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 16px;
  ...
  .project-sort {
    ...
    .sort-select .ant-select-selection-placeholder {
        font-weight: 400;  /* lighter than options */
        color: #555;       /* subtle gray */
        font-style: normal; /* optional: can also use italic */
      }
      
      /* Dropdown options remain normal/bolder */
      .sort-select .ant-select-item-option-content {
        font-weight: 600;
        color: #000;
      }
  }
